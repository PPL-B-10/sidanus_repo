<?php
	function showKategoriDrop()
  	...
  	function getId()
  	{
		...
		$sql = "SELECT t.idToko FROM toko t, penjual p WHERE p.username='$user' AND p.idToko=t.idToko";
	  	$hasil = mysql_query($sql);
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-2" style="margin-top: 18px">
						...
						<div class="shop-menu pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default get dropdown-toggle" data-toggle="dropdown">Toko <span class="caret"></span></button>
								<ul class="dropdown-menu" role="menu">
									<li><a href="<?php echo base_url().'index.php/tokocontroller/tampilkanToko/?idtoko='.getId(); ?>">Lihat Profil</a></li>
									<li><a href="<?php echo base_url().'index.php/tokocontroller/ubahprofiltoko/?i=ubah'; ?>">Ubah Profil</a></li>
									<li><a href="<?php echo base_url().'index.php/produkcontroller/addProduk/'; ?>">Tambah Produk</a></li>
								<li><a href="<?php echo base_url().'index.php/transaksicontroller/getDataTransaksi';  ?>">Data Transaksi</a></li>
								</ul>
							</div>
						</div>
					</div>
